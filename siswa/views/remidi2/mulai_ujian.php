  <div class="card">
    ...
    <div class="card-body p-0">
      ...
      <div class="card-px text-center py-20 my-10">
        <!--begin::Title-->
        <h2 class="fs-2x fw-bolder mb-10">Mulai Mengerjakan Remidi 2!</h2>
        <!--end::Title-->
        <!--begin::Description-->
        <p class="text-gray-400 fs-4 fw-bold mb-10">Pastikan Kode Soal sudah sesuai<br>
          ...
          <?php if ($datapenugasan['durasi_menit_r2'] == 0) : ?>
            <br>Kerjakan sebelum
          <?php else : ?>
            <br>Batas waktu mengerjakan adalah
            <br> <b class="text-primary fs-1"><?= $datapenugasan['durasi_menit_r2'] ?> menit</b>
            <br>Tugas akan berakhir pada
          <?php endif; ?>
          <br> <b class="text-primary"><?= tgl_indo(date("d-m-Y", strtotime($datapenugasan['batas_r2']))) ?> pukul <?= date("H:i", strtotime($datapenugasan['batas_r2'])) ?> WIB</b>
        </p>
        <!--end::Description-->
        <!--begin::Action-->
