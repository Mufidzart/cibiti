                  ...
                  <div class="col-6">
                    <div class="card card-stretch">
                      <a href="#r" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                        ...
                        <!--end::Svg Icon-->
                        <span class="fs-4 fw-bolder">Best Deals</span>
                      </a>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="card card-stretch">
                      <a href="#r" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                        ...
                        <!--end::Svg Icon-->
                        <span class="fs-4 fw-bolder">Hot Picks</span>
                      </a>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="card card-stretch">
                      <a href="#r" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                        ...
                        <!--end::Svg Icon-->
                        <span class="fs-4 fw-bolder">Latest Trands</span>
                      </a>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="card card-stretch">
                      <a href="#r" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                        ...
                        <!--end::Svg Icon-->
                        <span class="fs-4 fw-bolder">New Arrivals</span>
                      </a>
                    </div>
                  </div>
                </div>
  ...
  <div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'300px', 'lg': '900px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_activities_toggle" data-kt-drawer-close="#kt_activities_close">
    <div class="card shadow-none rounded-0">
      ...
      <div class="card-footer py-5 text-center" id="kt_activities_footer">
        <a href="../../demo9/dist/pages/profile/activity.html" class="btn btn-bg-body text-primary">View All Activities
          <!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
