...
$id_staf = $_GET['g'];
$id_mapel = $_GET['mpl'];
$getkelas =  $conn->query("SELECT * FROM arf_kelas WHERE parent_id=$kelas_siswa AND id=$subkelas_siswa");
...
$getguru =  $conn->query("SELECT * FROM arf_staf WHERE nip='$id_staf'");
            ...
            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
              ...
              <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center mb-2">
                  <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1"><?= $datamapel['nama_mapel'] ?></a>
                  <a href="#">
                ...
                <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                  <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                    ...
                    <!--end::Svg Icon--><?= $dataguru['nama_lengkap'] ?>
                  </a>
                  <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                    ...
                    <!--end::Svg Icon--><?= $grade . " " . $datakelas['nama_kelas'] ?>
                  </a>
            ...
            <div class="d-flex flex-wrap flex-stack">
              ...
              <div class="d-flex flex-column flex-grow-1 pe-8">
                ...
                <div class="d-flex flex-wrap">
                  <span class="fs-5 fw-bold text-gray-600 pb-6 d-block">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</span>
                </div>
                <!--end::Stats-->
              </div>
              <!--end::Wrapper-->
